...
namespace Package.CustomLibrary
{
    ...
    public class UtilitiesGen
    {
        ...
        private static Implementation.UtilitiesGen instance;

        private static Implementation.UtilitiesGen Instance
        {
            get { return instance ?? (instance = Object.FindObjectOfType<Implementation.UtilitiesGen>()); }
        }
        ...
        public static Coroutine LoadScene(IConvertible _sceneName, float _minSeconds = .0f, Button _buttonToDisable = null, LoadSceneMode _sceneMode = LoadSceneMode.Single, Image _imageToFill = null, Text _textToShow = null)
        {
